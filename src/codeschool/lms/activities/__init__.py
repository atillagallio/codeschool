...
activity" in which the student simply has to visit a page to download content.
...
ResponseSession object that helps tracks students responses to the given
activity. In simple activities, the Session may last for a single request, but
more complex interactions spanning several requests are also possible.
